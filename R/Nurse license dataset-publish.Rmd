...
#Remove any applications after Sept. 23, 2021 >> 64239
...
#removes 87,425 total records, to end up with 1,459,037 records. Some overlap if nurses applied and were issued after Sept. 23)
...
1.4 million rows x 44 columns, so will be a very large file.
```{r}
...
* 21 states included pending applicants.
