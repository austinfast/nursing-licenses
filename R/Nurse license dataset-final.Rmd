...
#Austin: Before running, find&replace State data/ with /Users/austinfast/Documents/NPR/210908-nursing licenses/State data/
```
...
```{r}
#state <- read_excel("/Users/austinfast/Documents/NPR/210908-nursing licenses/State data/NC-NPRApplicationData.xlsx") %>%
#  clean_names() 
...
In these 31 states, over half (58%) the 219,000 RNs and LPNs issued new licenses Jan. 1-Sept. 23, 2021, waited more than two months (126,006 nurses). Over one-third  (36%) of nurses (78,687) waited more than 3 months to get a new license issued in 2021.
